    ...
    return (
        <footer className="bg-gray-800 text-gray-200 py-10">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-0">
                ...
                {/* Company Info */}
                <div>
                    <h2 className="text-xl font-bold text-white mb-4">bjs </h2>
                    <p className="mb-4">
                        We provide reliable bjs services across the country, connecting businesses with their bjsation needs.
                    </p>
            ...
            <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm">
                <p>&copy; {new Date().getFullYear()} bjs Company. All rights reserved.</p>
