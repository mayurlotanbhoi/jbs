...
const DropdownUser = ({ name, user_type }) => {
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 flex justify-center items-center bg-blue-700 rounded-full">
          <div className=' capitalize font-bold   text-white text-2xl'>{name && name?.charAt(0)}</div>
