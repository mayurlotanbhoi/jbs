...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const handleFormSubmission = async () => {
      await handleRequest(
        () => registation(data),  // The API call function
        {
          ...
          <div className="w-full  border-stroke  dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full  p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form className=' text-black' onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                {errors.name && <p id="username-error" className="text-red-500 text-xs mt-1 ">{errors.name.message}</p>}
                ...
                <DatePicker
                  ...
                  className={`w-full cursor-pointer rounded-lg border bg-transparent outline-none transition file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:bg-white file:py-3 file:px-5 file:hover:bg-primary file:hover:text-white file:hover:bg-opacity-10
                                   ${errors.dob ? "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 " : " border-stroke focus:border-green-500 dark:focus:border-green-500"} 
                  ...
                  errorSms={errors.dob && <p className="text-red-500 text-xs mt-1">{errors.dob.message}</p>}
                />
                <InputField
                  type="text"
                  ...
                  label="State Name"
                  className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus-visible:shadow-none 
                        ${errors.state ? "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 " : " border-stroke focus:border-green-500 dark:focus:border-green-500 "} 
                       dark:border-form-strokedark dark:bg-form-input dark:text-white `}
                  {...register("state", {
                    required: "Please Enter State Name",
                    minLength: {
                      value: 3,
                      message: "Name State should be greater than 3 letter"
                    },
                    maxLength: {
                      value: 40,
                      message: "Name State should be less than 40 letter"
                    }
                  })}
                  onChange={(e) => handleChange("state", e)}
                  icon={<MdOutlineHomeWork className=" " size={25} />}
                />
                {errors.state && <p id="username-error" className="text-red-500 text-xs mt-1 ">{errors.state.message}</p>}
                ...
                <InputField
                  ...
                  label="district Name"
                  className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus-visible:shadow-none 
                        ${errors.district ? "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 " : " border-stroke focus:border-green-500 dark:focus:border-green-500 "} 
                       dark:border-form-strokedark dark:bg-form-input dark:text-white `}
                  {...register("district", {
                    required: "Please Enter district Name",
                    minLength: {
                      value: 3,
                      message: "Name district should be greater than 3 letter"
                    },
                    maxLength: {
                      value: 40,
                      message: "Name district should be less than 40 letter"
                    }
                  })}
                  onChange={(e) => handleChange("district", e)}
                  icon={<MdOutlineHomeWork className=" " size={25} />}
                />
                {errors.district && <p id="username-error" className="text-red-500 text-xs mt-1 ">{errors.district.message}</p>}
                ...
                <InputField
                  ...
                  label="Taluka Name"
                  className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus-visible:shadow-none 
                        ${errors.taluka ? "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 " : " border-stroke focus:border-green-500 dark:focus:border-green-500 "} 
                       dark:border-form-strokedark dark:bg-form-input dark:text-white `}
                  {...register("taluka", {
                    required: "Please Enter Taluka Name",
                    minLength: {
                      value: 3,
                      message: "Name Taluka should be greater than 3 letter"
                    },
                    maxLength: {
                      value: 40,
                      message: "Name Taluka should be less than 40 letter"
                    }
                  })}
                  onChange={(e) => handleChange("taluka", e)}
                  icon={<MdOutlineHomeWork className=" " size={25} />}
                />
                {errors.taluka && <p id="username-error" className="text-red-500 text-xs mt-1 ">{errors.taluka.message}</p>}
                ...
                <InputField
                  ...
                  className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus-visible:shadow-none 
                        ${errors.city ? "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 " : " border-stroke focus:border-green-500 dark:focus:border-green-500 "} 
                       dark:border-form-strokedark dark:bg-form-input dark:text-white `}
                  {...register("city", {
                    required: "Please Enter Taluka Name",
                    minLength: {
                  ...
                  icon={<MdOutlineHomeWork className=" " size={25} />}
                />
                {errors.city && <p id="username-error" className="text-red-500 text-xs mt-1 ">{errors.city.message}</p>}
